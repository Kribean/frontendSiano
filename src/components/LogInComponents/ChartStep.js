...
{props.mistakeIsDone&&      <div className="alert alert-error">
        ...
        <span>Oops ! Une erreur s'est produite. Nous nous excusons pour ce désagrément. Veuillez vérifier que vous n'avez pas déjà créé un compte avec la même adresse e-mail ou le même numéro de SIREN. Si l'erreur persiste, n'hésitez pas à nous contacter via nos réseaux sociaux ou par e-mail à sianoproject@gmail.com</span>
      </div>}
