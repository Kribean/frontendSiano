...
export default function FormStep({setGoToChart}){
  ...
  <label className="label cursor-pointer">
    <span className="label-text">Je n'ai une certification anti-chloredécone</span> 
    <input type="radio" name="radio-10" className="radio checked:bg-neutral"  />
  </label>
</div>
<div className="form-control">
  <label className="label cursor-pointer">
    <span className="label-text">J'ai une certification anti-chloredécone</span> 
    <input type="radio" name="radio-10" className="radio checked:bg-success" />
  </label>
</div>
              <div className="form-control">
                <label className="label">
              ...
              <button onClick={()=>{setGoToChart(true)}} className="btn btn-primary" href="/login">
                Valider
              </button>
            </div>
          </div>
